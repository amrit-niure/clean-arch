...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."outcome" AS ENUM('SUCCESSFUL', 'UNSUCCESSFUL', 'PENDING');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."overseer" AS ENUM('DEEPAK', 'GANESH');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."sa_status" AS ENUM('SUBMITTED', 'UNDER_ASSESSMENT', 'ADDITIONAL_INFO_REQUIRED', 'COMPLETED', 'APPEALED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."sa_type" AS ENUM('SKILLS_ASSESSMENT', 'QUALIFICATION_ASSESSMENT', 'PROVISIONAL_SKILLS_ASSESSMENT');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."sbs_status" AS ENUM('PENDING', 'APPROVED', 'NOT APPROVED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
